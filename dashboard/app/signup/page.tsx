...
// No unused Lucide imports needed as we use Material Symbols for branding consistency
...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            if (error.status === 422 || error.message?.toLowerCase().includes("exists")) {
                ...
                if (!resendError) {
                    toast.info("User already exists", {
                        description: "We've resent a verification email. Please check your inbox.",
                    });
                    setLoading(false);
                    router.push("/login");
                    return;
            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                <div className="flex flex-col gap-6">
                    <Card className="p-8 md:p-12 rounded-[2.5rem] shadow-sm border-slate-200/50 flex-grow bg-white">
                        ...
                        <div className="mb-10">
                            <h1 className="text-4xl md:text-5xl font-outfit font-semibold text-slate-900 mb-4 leading-tight tracking-tight">Join the OpenBrain movement</h1>
                            <p className="text-slate-500 text-lg">Your open-source second brain for building knowledge and connecting dots.</p>
                        </div>
                        <form className="space-y-4" onSubmit={handleSignup}>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <div className="relative">
                                        <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 z-10">person</span>
                                        <Input
                ...
                <div className="relative overflow-hidden rounded-[3rem] bg-primary flex flex-col justify-between p-8 md:p-12 text-white">
                    ...
                    <div className="relative z-10">
                        <h2 className="text-4xl md:text-5xl font-outfit font-medium leading-tight mb-6">
                            Your thoughts,<br />structured and open.
                        </h2>
                    </div>
                        ...
                        <div className="relative w-full max-w-sm aspect-square">
                            <div className="absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="absolute w-24 h-24 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 transform rotate-45 flex items-center justify-center shadow-2xl">
                                    <span className="material-symbols-outlined text-4xl transform -rotate-45 leading-none">hub</span>
                                </div>
                    ...
                    <div className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl">
                        ...
                        <p className="text-white/90 font-light leading-relaxed">
                            Build a personal graph of knowledge. Connect ideas across journals, projects, and literature with semantic linking.
                        </p>
